...
export const MainLayout = ({ children }: MainLayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-dark-50">
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-dark-900 transform transition-transform duration-300 ease-in-out ${
          ...
          <div className="p-4 border-t border-dark-800">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-dark-400 truncate">{user?.email ?? 'guest@example.com'}</p>
              </div>
            </div>
            <button
